...
<div class="container">
	...
	<div class="jumbotron" style="background-color: maroon;">
		<h1 class="display-4 text-white">Login into Blood Bank</h1>
	</div>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="w3-light-grey w3-border w3-panel w3-padding-16">
				...
				<a class="btn btn-outline-danger" href="#" id="user_login_btn">Login as Reciever</a>
			</div>
		</div>
		<div class="col-md-6">
			<div class="w3-light-grey w3-border w3-panel w3-padding-16">
				...
				<a class="btn btn-outline-danger" href="#" id="hospital_login_btn">Login as Bank</a>
			</div>
		</div>
	</div>
</div>
